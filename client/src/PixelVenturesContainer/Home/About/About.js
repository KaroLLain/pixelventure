...
export default function About () {
  ...
  return (
    <section ref={myRef} className='about fade-in' id='aboutSection'>
      <picture
        className={`${'aboutPictureWrapper'} ${fadeInSection ? 'show' : ''}`}
      >
      ...
      <div className={`${'aboutBox'} ${fadeInSection ? 'show' : ''}`}>
        <h3 className='aboutHeader'>
          <span className='muscle'>Hello</span> I'm Karolina
        </h3>
        <p className='aboutText'>
          ...
          basics of frontend HTML, CSS, SASS, so that I could later dive into
          technologies like JavaScript, React, or Typescript. <br /> Driven by
          my love for creativity and willing to constantly evolve I made
          creating websites my new passion. My aesthetic sense and basic
          knowledge in UX/UI allows me to design sites, that are modern,

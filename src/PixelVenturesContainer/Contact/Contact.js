...
export default function Contact() {
    return (
        ...
        <div class="contact__container">
          <h1 class="contact__container__header portfolio__header">get in touch</h1>
          <div class="contact__container__content">
            ...
            <div class="contact__container__content__info">
              <p class="contact__container__content__info--header h__second">Contact info:</p>
              <div class="contact__container__content__info__wrapper">
                ...
                <span></span>
                <div class="contact__container__content__info__wrapper__box">
                  <div class="contact__container__content__info--name h__third">Karolina</div>
                  <div class="contact__container__content__info--email h__third">karolain@wop.pl</div>
                </div>
              </div>
            </div>
          </div>
